...
while True:
    ...
    thresholed = cv.inRange(
        hsv_image, (low_H, low_S, low_V), (high_H, high_S, high_V))

    cv.imshow(window_capture_name, original_img)
    cv.imshow(window_detection_name, thresholed)
