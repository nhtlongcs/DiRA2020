...
int main(int argc, char **argv)
{
  ...
  std::string camera_name = "/team220/camera/rgb";
  ...
  image_transport::SubscriberFilter color_sub(it, "/team220/camera/rgb", 1);
  image_transport::SubscriberFilter depth_sub(it, "/team220/camera/depth", 1);
